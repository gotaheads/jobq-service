...
exports.landscapequoting = function () {
    console.log('starting landscapequoting..');
    landscapequoting = {}

    landscapequoting.loadQuota = function (id) {
        return new Promise(function (resolve) {
            ...
            request.get(url).end(function(err, res) {
                console.log('quote loaded: %j, status:%s, err:%s', res.text, res.status,
